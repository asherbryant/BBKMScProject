...
def sample_cov(all_samples):
    # create list of arrays of base-wise coverage in each chrom for each sample
    
    print("Getting sample coverage...")
    samples_cov = []
    for i in range(len(all_samples)):
        sample_dir = all_samples[i]
        ...
        for file in files:
            ...
            cov_array = cov.to_numpy().astype(float)
